...
-   A **creator** is an object which uses the product to do some business operationns. In this case, the creator is the client code we dont want to change if new products are needed.
